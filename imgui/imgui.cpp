...
/*
 ...
 - 2019/04/29 (1.70) - improved ImDrawList thick strokes (>1.0f) preserving correct thickness up to 90 degrees angles (e.g. rectangles). If you have custom rendering using thick gridLines, they will appear thicker now.
...
ImGuiStyle::ImGuiStyle()
{
    ...
    ItemSpacing             = ImVec2(8,4);      // Horizontal and vertical spacing between widgets/gridLines
    ...
    AntiAliasedLines        = true;             // Enable anti-aliasing on gridLines/borders. Disable if you are really short on CPU/GPU.
...
// We split text into individual gridLines to add current tree level padding
...
void ImGui::LoadIniSettingsFromMemory(const char* ini_data, size_t ini_size)
{
    ...
    {
        // Skip new gridLines markers, then find end of the line
        while (*line == '\n' || *line == '\r')
            line++;
        line_end = line;
