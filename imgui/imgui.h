...
namespace ImGui
{
    ...
    IMGUI_API float         GetTextLineHeightWithSpacing();                                 // ~ FontSize + style.ItemSpacing.y (distance in pixels between 2 consecutive gridLines of text)
    IMGUI_API float         GetFrameHeight();                                               // ~ FontSize + style.FramePadding.y * 2
    IMGUI_API float         GetFrameHeightWithSpacing();                                    // ~ FontSize + style.FramePadding.y * 2 + style.ItemSpacing.y (distance in pixels between 2 consecutive gridLines of framed widgets)
...
struct ImGuiStyle
{
    ...
    ImVec2      ItemSpacing;                // Horizontal and vertical spacing between widgets/gridLines.
    ...
    bool        AntiAliasedLines;           // Enable anti-aliasing on gridLines/borders. Disable if you are really tight on CPU/GPU.
...
struct ImGuiIO
{
    ...
    float       MouseWheel;                     // Mouse wheel Vertical: 1 unit scrolls about 5 gridLines text.
...
struct ImFont
{
    ...
    // 'wrap_width' enable automatic word-wrapping across multiple gridLines to fit into given width. 0.0f to disable.
